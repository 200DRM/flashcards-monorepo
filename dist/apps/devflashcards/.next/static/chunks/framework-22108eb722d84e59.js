  ...
  [774],
  {
    2967: function (e, n, t) {
      ...
      for (var t5 = 0; t5 < t8.length; t5++) {
        var t7 = t8[t5];
        t6(t7.toLowerCase(), "on" + (t7[0].toUpperCase() + t7.slice(1)));
      }
      ...
      function ae(e, n) {
        switch ((rH(l7, n), rH(l5, e), rH(l6, l8), (e = n.nodeType))) {
          case 9:
          case 11:
                    ...
                    if (((t = n.type), null !== e && null != n.stateNode))
                      ...
                      if (((e = l9(l6.current)), ly(n))) {
                        ...
                        switch (
                          ...
                          case "video":
                          case "audio":
                            for (i = 0; i < t9.length; i++) rr(t9[i], r);
                            break;
                          case "source":
                            rr("error", r);
                            break;
                        ...
                        e: {
                          switch (((c = eS(t, r)), t)) {
                            ...
                            case "video":
                            case "audio":
                              for (i = 0; i < t9.length; i++) rr(t9[i], e);
                              i = r;
                              break;
                            case "source":
                              rr("error", e), (i = r);
          ...
          try {
            if (((u2.transition = null), (nf = 16 > e ? 16 : e), null === op))
              ...
              if (
                ((u3 = l),
                r8(),
                e7 && "function" == typeof e7.onPostCommitFiberRoot)
              )
                try {
                  e7.onPostCommitFiberRoot(e5, e);
                } catch (x) {}
              r = !0;
            }
            return r;
      ...
      function oj(e, n, t) {
        ...
        null !== r && r.delete(n),
          ...
          u4 === e &&
            (u6 & t) === t &&
            (4 === u9 ||
            (3 === u9 && (130023424 & u6) === u6 && 500 > e0() - ou)
              ? oL(e, 0)
              : (or |= t)),
          oS(e, n);
      }
