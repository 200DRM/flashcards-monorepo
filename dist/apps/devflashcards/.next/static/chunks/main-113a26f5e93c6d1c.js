                      ...
                      if (i.startsWith("/")) {
                        ...
                        return Promise.all([
                          ...
                          if (
                            ...
                            (i = j.addBasePath(l.pathname)), (c.pathname = i);
                          }
                          if (!n.includes(f)) {
                            let s = U(f, n);
                            s !== f && (f = s);
        ...
        change(e, t, r, o, i) {
          ...
          return n(function* () {
            ...
            try {
              ...
              if ("route" in eh && er) {
                (Q = V = eh.route || Q),
                  H.shallow || ($ = Object.assign({}, eh.query || {}, $));
                ...
                if (
                  ...
                  let eg =
                    ...
                    ey = eg;
                  C.hasBasePath(ey) && (ey = x.removeBasePath(ey));
              ...
              if ("type" in eh) {
                ...
                return (
                  X({ url: eh.destination, router: l }), new Promise(() => {})
                );
              }
              let { error: eP, props: eb, __N_SSG: eS, __N_SSP: ew } = eh,
                eE = eh.Component;
              ...
              if ((eS || ew) && eb) {
                if (eb.pageProps && eb.pageProps.__N_REDIRECT) {
                  ...
                  return X({ url: ej, router: l }), new Promise(() => {});
                }
              ...
              let eL =
                  o.shallow && v.route === (null != (ef = eh.route) ? ef : Q),
                eT = null != (ep = o.scroll) ? ep : !o._h && !eL,
                eI = a({}, v, {
                  route: Q,
                  pathname: V,
                  query: $,
              ...
              if (!ek) {
                if (
                  ...
                  throw (p || Y.events.emit("routeChangeError", eP, q, H), eP);
            ...
            try {
              ...
              if (
                ...
                if (
                  ...
                  (l = x.removeBasePath(
                    p.normalizeLocalePath(R.effect.parsedAs.pathname, v.locales)
                      .pathname
                  )),
                  (j = v.components[e]),
